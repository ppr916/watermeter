...
#ifdef ESP8266
#define SPI_CSK 14 // PIN_SPI_SCK // example replace by 14 for d1 mini pro
#define SPI_MISO 12 // PIN_SPI_MISO // example replace by 12 for d1 mini pro
#define SPI_MOSI 13 // PIN_SPI_MOSI // example replace by 13 for d1 mini pro
#define SPI_SS 15 //  PIN_SPI_SS // example replace by 15 for d1 mini pro SS or CS pin
#endif
